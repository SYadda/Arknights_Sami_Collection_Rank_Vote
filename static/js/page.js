...
function new_compare() {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            [left_name, right_name, left_effect, right_effect, left_price, right_price, code] = name;
            ...
            document.getElementById("left_png_effect").innerText = left_effect;
            document.getElementById("right_png_effect").innerText = right_effect;

            document.getElementById("left_png_price").innerText = left_price + ' 源石锭';
            document.getElementById("right_png_price").innerText = right_price + ' 源石锭';
        }
    }
}
